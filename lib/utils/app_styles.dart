...
class AppStyles {
  ...
  static TextStyle semi20PrimaryDark = GoogleFonts.inter(
      fontSize: 20, fontWeight: FontWeight.w700, color: AppColors.primaryDark);
  static TextStyle bold14PrimaryDark = GoogleFonts.inter(
  ...
  static TextStyle medium16PrimaryDark= GoogleFonts.inter(
  ...
  static TextStyle medium16Gray= GoogleFonts.inter(
      fontSize: 16, fontWeight: FontWeight.w500, color: AppColors.grayColor);
